...
public class PollQuestionCreate {
	...
	@Test
	public void pollQuestionCreateTest() {
		PollQuestionOptionResource pollQuestionResource = setPollQuestionResource();
		try {
			this.mockMvc.perform(post("/pollQuestion/create/9")
	...
	private PollQuestionOptionResource setPollQuestionResource() {
		...
		pollQuestionResource.setQuestion("Question 66");
